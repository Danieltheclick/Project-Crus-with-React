                        ...
                        <ModalBody>
                            <div className="container-fluid">
                                <form className="form row mt-3 formulario py-4" id="myForm" onSubmit={handleEditSubitm}>
                                    <label for="WorkManager" class="form-label col-1"><i class="fas fa-project-diagram"></i></label>
                                    ...
                                    <label for="AttachmentName" class="form-label col-1"><i class="fas fa-battery-three-quarters"></i> </label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                    ...
                                    <label for="BillNumber" class="form-label col-1"><i class="fas fa-calendar-check"></i> </label>
                                    <div className="div col-5">
                                        <input
                                            type="date"
                                    ...
                                    <label for="PurchaseOrder" class="form-label col-1"><i class="fas fa-calendar-check"></i></label>
                                    <div className="div col-5">
                                        <input
                                            type="date"
                                    ...
                                    <label for="Provider" class="form-label col-1"><i class="fas fa-calendar-check"></i></label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                            name="provider"
                                    ...
                                    <label for="Description" class="form-label col-1"><i class="fas fa-arrow-circle-right"></i> </label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                    ...
                                    <label for="FacturationPeriod" className="form-label col-1"><i class="fas fa-address-card"></i> </label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                    ...
                                    <label for="InvoiceMonth" className="form-label col-1"><i class="fas fa-address-card"></i></label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                            name="invoiceMonth"
                                            ...
                                            onChange={handleEditChange}
                                        >
                                            <option value="anuary _ 31 days"> January _ 31 days </option>
                                            ...
                                            <option value="December _ 31 days"> December _ 31 days</option>
                                        </select>
                                    </div>
                                    <label for="Society" className="form-label col-1"><i class="fas fa-address-card"></i></label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                            name="society"
                                    ...
                                    <label for="DateAdmission" class="form-label col-1"><i class="fas fa-arrow-circle-right"></i> </label>
                                    <div className="div col-5">
                                        <input
                                            type="date"
                                            name="dateAdmission"
                                    ...
                                    <label for="Value" className="form-label col-1"><i class="fas fa-arrow-circle-right"></i></label>
                                    <div className="div col-5">
                                        <input
                                            type="number"
                                    ...
                                    <label for="CurrencyType" className="form-label col-1"><i class="fas fa-address-card"></i> </label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                            name="currencyType"
                                    ...
                                    <label for="Cecos" className="form-label col-1"><i class="fas fa-percentage"></i></label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                    ...
                                    <label for="Status" className="form-label col-1"><i class="fas fa-address-card"></i></label>
                                    <div className="div col-5">
                                        <select
                                            className="form-control mb-2"
                                            name="status"
