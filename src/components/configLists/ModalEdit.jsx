                        ...
                        <ModalBody>
                            <div className="container-fluid">
                                <form className="form row mt-3 formulario py-4" id="myForm" onSubmit={handleEditSubitm}>
                                    <label for="TypeRequeriment" class="form-label col-1"><i class="fas fa-project-diagram"></i></label>
                                    ...
                                    <label for="StatusPrice" class="form-label col-1"><i class="fas fa-battery-three-quarters"></i> </label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                    ...
                                    <label for="TypeField" class="form-label col-1"><i class="fas fa-calendar-check"></i>  </label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                    ...
                                    <label for="Approval" class="form-label col-1"><i class="fas fa-calendar-check"></i>  </label>
                                    <div className="div col-5">
                                        <input
                                            type="text"
                                            placeholder="Ingrese la fecha de inicio"
